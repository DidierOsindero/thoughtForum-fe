  ...
  return (
    <div className="postsPageContainer">
      ...
      <div className="postsContainer">
        ...
        <div className="post">
          <img
            src="https://images.unsplash.com/photo-1670772295035-6baf4bf424ac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDMyfHFQWXNEenZKT1ljfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
            alt=""
            className="postIMG"
          />
          <div className="postTitle">
            <h3>Why I'm scared of the future</h3>
        ...
        <div className="post">
          <img
            src="https://images.unsplash.com/photo-1670787196366-11b4a82501e4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDEyfHFQWXNEenZKT1ljfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
            alt=""
            className="postIMG"
          />
          <div className="postTitle">
            <h3>When magic is deceptive</h3>
        ...
        <div className="post">
          <img
            src="https://images.unsplash.com/photo-1671557488735-1c5d99cfe045?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxNXx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=60"
            alt=""
            className="postIMG"
          />
          <div className="postTitle">
