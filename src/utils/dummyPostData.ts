...
export const dummyData: IPostData[] = [
  {
    user_id: "1",
    post_id: 1,
  ...
  {
    post_id: 3,
    user_id: "Bearer mytoken",
    title: "THE WONDERS OF THE WORLD",
    content: "This is a test blog post about the wonders of the world",
    img: "blob:http://localhost:3000/d91d09f1-c977-49ca-90bb-f83220304ca9",
    type: "thought",
    privacy: "public",
    hearts: 0,
    creation_date: "2022-12-23T11:59:55.409Z",
  },
  {
    user_id: "1",
    post_id: 2,
